 ...
 * @author patricio
 */
@WebServlet(name = "IndicadorMensualMainServlet", urlPatterns = {"/IndicadorMensualMainServlet"})
public class IndicadorMensualMainServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (userTypeX > 2) {
                    ...
                    try {
                        Collection<IndicadorEconomicoMensualBean> list = imDAO.indicadorMensualGetAll();
                    ...
                    request.getRequestDispatcher("/indicadorEconomico/indicadorMensualMain.jsp").forward(request, response);
                }
            } catch (Exception ex) {
