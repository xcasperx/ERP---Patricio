 ...
 * @author patricio
 */
@WebServlet(name = "IndicadorMensualDeleteServlet", urlPatterns = {"/IndicadorMensualDeleteServlet"})
public class IndicadorMensualDeleteServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if (userTypeX > 4) {
                    ...
                    session.setAttribute("redirectDel", "indicadorMensual");
                    ...
                    if (btnDelRow != null) {
                        try {
                            ...
                            imDAO.indicadorMensualDelete(id);
                    ...
                    if (btnDelCol != null) {
                        ...
                        try {
                            while (outerArray[i] != null) {
                                try {
                                    imDAO.indicadorMensualDelete(Integer.parseInt(outerArray[i]));
                                    cont++;
                                } catch (Exception ex) {
                    ...
                    /* send redirect */
                    response.sendRedirect("IndicadorMensualMainServlet");
                }
