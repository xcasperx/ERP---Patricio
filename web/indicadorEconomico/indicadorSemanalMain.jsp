<%-- 
    Document   : indicadorSemanalMain
    Created on : 24-04-2014, 18:08:10 AM
    Author     : patricio
--%>
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                              
                            <div class="btn-toolbar">                                    
                                <object align="right">
                                    ...
                                    <div class="btn-group">                                                      
                                        <button class="btn btn-default btn-sm" name="btnAdd" type="button" onclick="location.href = 'IndicadorSemanalGetAddServlet';" rel="tooltip" data-placement="top" data-original-title="Nuevo indicador">
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-2" data-widget-togglebutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form action="IndicadorSemanalDeleteServlet" method="post" name="form">
                                                ...
                                                <tbody>
                                                    <c:forEach var="list" items="${list}">
                                                        <tr>
                                                            ...
                                                            <td><c:out value="${list.bencina93}" /></td>
                                                ...
                                                $("#btnDelRow<c:out value="${list.id}"/>").click(function(e) {
                                                    ...
                                                    $.SmartMessageBox({
                                                        ...
                                                        if (ButtonPressed === "Sí") {
                                                            ...
                                                            var url = 'IndicadorSemanalDeleteServlet?btnDelRow&id=' + $('#idDelRow<c:out value="${list.id}"/>').attr("value");
