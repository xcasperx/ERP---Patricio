...
$(document).ready(function() {
	...
	$('#logout a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Desea cerrar <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : $.logoutMSG || "Cerrar la sesión de usuario a través de esta ventana aumentará su seguridad.",
			buttons : '[No][Sí]'
