    ...
    (function(factory) {
        ...
        var DataTable = function(oInit) {
            ...
            function _fnFeatureHtmlFilter(oSettings) {
                ...
                sSearchStr = (sSearchStr.indexOf("_INPUT_") !== -1) ? sSearchStr.replace("_INPUT_", '<input class="form-control"  placeholder="Filtrar" type="text">') : sSearchStr === "" ? '<input type="text" />' : sSearchStr + ' <input type="text" />';
            ...
            this.fnFilter = function(sInput, iColumn, bRegex, bSmart, bShowGlobal, bCaseInsensitive) {
                ...
                if (iColumn === undefined || iColumn === null) {
                    _fnFilterComplete(oSettings, {sSearch: sInput + "", bRegex: bRegex, bSmart: bSmart, bCaseInsensitive: bCaseInsensitive}, 1);
                    ...
                    $.extend(oSettings.aoPreSearchCols[iColumn], {sSearch: sInput + "", bRegex: bRegex, bSmart: bSmart, bCaseInsensitive: bCaseInsensitive});
                    _fnFilterComplete(oSettings, oSettings.oPreviousSearch, 1);
                }
            };
        ...
        $.extend(DataTable.ext.oPagination, {two_button: {fnInit: function(oSettings, nPaging, fnCallbackDraw) {
