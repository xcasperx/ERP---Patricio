(function($, window, document, undefined) {
    ...
    Plugin.prototype = {_settings: function() {
            ...
            self.widget.on(clickEvent, ".jarviswidget-delete-btn", function(e) {
                ...
                $.SmartMessageBox({title: "<i class='fa fa-times' style='color:#ed1c24'></i> " + self.o.labelDelete + ' "' + widTitle + '"', content: "Precaución: Si elimina este widget, para recuperarlo deberá reiniciar la configuración de widgets.", buttons: "[No][Sí]"}, function(ButtonPressed) {
                    if (ButtonPressed == "Sí") {
                        self._runLoaderWidget($(this));
