...
<html lang="es">
    <head>       
        ...
        <title> Latte ERP | Clientes </title>
    ...
    <body class="">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                              
                            <div class="btn-toolbar">                                    
                                <object align="right">
                                    ...
                                    <div class="btn-group">                                                      
                                        <button class="btn btn-default btn-sm" name="btnAdd" type="button" onclick="location.href = 'ClienteGetAddServlet';" rel="tooltip" data-placement="top" data-original-title="Nuevo Cliente">
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-2" data-widget-togglebutton="false" data-widget-custombutton="false" data-widget-collapsed="false" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-colorbutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form action="ClienteDeleteServlet" method="post" name="form">
                                            <table id="datatable_col_reorder" class="table table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach var="list" items="${list}">
                                                        <tr>
                                                            <td class="center">
                                                                <input type="checkbox" name="chk" value="<c:out value="${list.rut}"/>"/>
                                                                <input type="hidden" value="x">
                                                            </td>
                                                            <td><c:out value="${list.rut}" />-<c:out value="${list.dv}" /></td>
                                                            <td><c:out value="${list.nombre}" /></td>
                                                            <td><c:out value="${list.direccion}" /></td>
                                                            <td><c:out value="${list.nombreCiudad}" /></td>
                                                            <td><c:out value="${list.telFijo}" /></td>
                                                            <td><c:out value="${list.email}" /></td>
                                                            <td width=280>
                                                                <div align="right">
                                                                    <a href="ClienteGetServlet?id=<c:out value="${list.rut}"/>">
                                                                    ...
                                                                    <button class="btn btn-labeled btn-danger" name="btnDelRow" id="btnDelRow<c:out value="${list.rut}"/>">                                                
                                                                        <span class="btn-label"><i class="glyphicon glyphicon-trash"></i></span>
                                                                        <span><font size="1">ELIMINAR</font></span>
                                                                    </button>
                                                                    <input type="hidden" name="clienteDelRow<c:out value="${list.rut}"/>" id="clienteDelRow<c:out value="${list.rut}"/>" value="<c:out value="${list.rut}"/>">
                                                                </div>                                                           
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
        ...
        <script type="text/javascript">
                                            ...
                                            $(document).ready(function() {
                                                ...
                                                // confirmar eliminar
            <c:forEach var="list" items="${list}">
                                                $("#btnDelRow<c:out value="${list.rut}"/>").click(function(e) {
                                                    ...
                                                    $.SmartMessageBox({
                                                        ...
                                                        if (ButtonPressed === "Sí") {
                                                            ...
                                                            var url = 'ClienteDeleteServlet?btnDelRow&rut=' + $('#clienteDelRow<c:out value="${list.rut}"/>').attr("value");
